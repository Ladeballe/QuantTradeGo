    ...
    for period in periods:
        for symbol in symbols:
            try:
                ...
                res = rq.get(
                    base_url + f'/futures/data/topLongShortAccountRatio?' + '&'.join([f'{k}={v}' for k, v in {
                ...
                df.to_sql(name="bnc_top_ls_acct_ratio_5m", con=mysql_conn, if_exists="append", index=False,
