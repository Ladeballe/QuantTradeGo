...
if __name__ == '__main__':
    ...
    xgbrank_strategy_0600_0800 = StrategyV2(  # 重新配置时间，模型存储位置，是否为test_mode
        'xgbrank_0600_0800',
        r'D:\research\CRYPTO_cross_sec_strategies\Strategy_v20\models\xgbrank_v2.1_fac_set_v1.3_0600_0800.json',
        {
            'open_pos': {'time': '06:00', 'type': 'MARKET', 'BUY': 'df_sig>0.95', 'SELL': 'df_sig<0.05'},
            'stop_loss': {'time': '06:00', 'type': 'STOP', 'long': 0.95, 'short': 1.05},
            'take_profit': {'time': '11:00', 'type': 'TAKE_PROFIT', 'long': 1.01, 'short': 0.99},
            'force_close_pos': {'time': '08:00', 'type': 'MARKET', 'long': 'close', 'short': 'close'}
        },
        400
    )
